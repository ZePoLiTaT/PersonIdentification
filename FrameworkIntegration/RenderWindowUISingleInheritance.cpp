...
RenderWindowUISingleInheritance::RenderWindowUISingleInheritance() 
{
	...
	featuresFrames = new concurrency::unbounded_buffer<std::shared_ptr<Kinect_Data>>();
	...
	FeaturesWorker *featuresWorker = new FeaturesWorker(featuresFrames);
...
RenderWindowUISingleInheritance::~RenderWindowUISingleInheritance()
{
	cout << "TOTAL FEATURES: " << frameNumber << endl;
