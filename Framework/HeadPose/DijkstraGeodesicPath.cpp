...
vtkStandardNewMacro(DijkstraGraphGeodesicPath);
vtkCxxSetObjectMacro(DijkstraGraphGeodesicPath, RepelVertices, vtkPoints);

//----------------------------------------------------------------------------
DijkstraGraphGeodesicPath::DijkstraGraphGeodesicPath()
{
...
//----------------------------------------------------------------------------
void DijkstraGraphGeodesicPath::GetCumulativeWeights(vtkDoubleArray *weights)
{
	if (!weights)
	{
		return;
...
//----------------------------------------------------------------------------
int DijkstraGraphGeodesicPath::RequestData(
...
//----------------------------------------------------------------------------
void DijkstraGraphGeodesicPath::Initialize(vtkDataSet *inData)
{
...
//----------------------------------------------------------------------------
void DijkstraGraphGeodesicPath::Reset()
{
...
//----------------------------------------------------------------------------
double DijkstraGraphGeodesicPath::CalculateStaticEdgeCost(
...
void DijkstraGraphGeodesicPath::BuildAdjacency(vtkDataSet *inData)
{
...
//----------------------------------------------------------------------------
void DijkstraGraphGeodesicPath::TraceShortestPath(
	...
	vtkIdType startv, vtkIdType endv)
{
	...
	while (v != startv)
	{
		...
		///Check if v is -1 then set flag and break;
		if (v == -1)
		{
			//TODO: Cleanup
...
//----------------------------------------------------------------------------
void DijkstraGraphGeodesicPath::Relax(const int& u, const int& v, const double& w)
{
...
//----------------------------------------------------------------------------
void DijkstraGraphGeodesicPath::ShortestPath(vtkDataSet *inData,
	int startv, int endv)
{
	int u, v;
...
//----------------------------------------------------------------------------
void DijkstraGraphGeodesicPath::PrintSelf(ostream& os, vtkIndent indent)
{
...
bool DijkstraGraphGeodesicPath::checkPathSuccess()
{
	return pathSuccess;
}
